  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex">
      ...
      <div className="flex-1 md:ml-0">
        <div className="container mx-auto px-4 py-8 md:px-8 md:py-12 ml-0 md:ml-4">
          {/* Header */}
          <div className="mb-12 mt-16 md:mt-0">
            <div className="text-center md:text-left">
              <h1 className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-blue-700 bg-clip-text text-transparent mb-4">
                Personal Finance
              </h1>
